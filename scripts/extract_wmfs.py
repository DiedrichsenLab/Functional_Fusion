...
def mask_wmfs_fs32k(ses_id='ses-s1', type='CondHalf', high_percent=0.1, low_percent=0.1,
...
if __name__ == "__main__":
    ...
    for s in [4]:
        ...
        mask_wmfs_fs32k(ses_id='ses-01', type=f'CondHalf', high_percent=0.1,
                         low_percent=0.1, smooth=f'{s}fwhm', z_transfer=True, binarized=False)
        mask_wmfs_fs32k(ses_id='ses-02', type=f'CondHalf', high_percent=0.1,
                         low_percent=0.1, smooth=f'{s}fwhm', z_transfer=True, binarized=False)
