...
if __name__ == '__main__':
    ...
    ses = 'ses-localizer_cond_fm'
    glm =  'glm_localizer_cond_fm'
    participant_list = ['sub-01','sub-02','sub-03','sub-04','sub-06','sub-07','sub-08','sub-09','sub-10','sub-12','sub-13','sub-14','sub-15','sub-16','sub-17','sub-18','sub-19'] #localizer
