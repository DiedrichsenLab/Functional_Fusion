...
def mask_nishi_fs32k(ses_id='ses-s1', type='CondHalf', high_percent=0.1, low_percent=0.1,
...
if __name__ == "__main__":
    ...
    # for s in [2,3,5,7,9]:
    #     smooth_nishi_fs32k(ses_id='ses-01', type='CondHalf', smooth=s, kernel='fwhm')
    #     smooth_nishi_fs32k(ses_id='ses-02', type='CondHalf', smooth=s, kernel='fwhm')

    for s in [4,6,8,10]:
        print(f'Doing processing for {s}fwhm ...')
        mask_nishi_fs32k(ses_id='ses-01', type=f'CondHalf', high_percent=0.1,
                         low_percent=0.1, smooth=f'{s}fwhm', z_transfer=True, binarized=False)
        mask_nishi_fs32k(ses_id='ses-02', type=f'CondHalf', high_percent=0.1,
                         low_percent=0.1, smooth=f'{s}fwhm', z_transfer=True, binarized=False)
