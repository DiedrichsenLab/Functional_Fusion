...
if __name__ == "__main__":
    ...
    lang_dataset.extract_all(ses_id='ses-rest', type='Tseries', atlas='MNISymC3', subj=subject_subset)
    lang_dataset.extract_all(ses_id='ses-rest', type='Tseries', atlas='fs32k', subj=subject_subset)
