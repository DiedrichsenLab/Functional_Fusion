...
def extract_pontine_suit(ses_id='ses-01',type='CondSes',atlas='SUIT3'):
    p7_dataset = DataSetPontine(data_dir)
    p7_dataset.extract_all_suit(ses_id,type,atlas)

def extract_pontine_fs32k(ses_id='ses-01',type='CondSes'):
    p7_dataset = DataSetPontine(data_dir)
...
if __name__ == "__main__":
    extract_pontine_suit(ses_id='ses-01',type='TaskSes')
    extract_pontine_fs32k(ses_id='ses-01',type='TaskSes')
