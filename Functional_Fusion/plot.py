...
def plot_rednucleus(data,
    ...
    #c1 = np.array([[-13,-28,-16],[1,-28,-16]]).T # Lower left corner of each image
    #c2 = np.array([[-1,-14,-2],[12,-14,-2]]).T # Upper right corner of each image

    c1 = np.array([[-25,-70,-16],[7,-70,-16]]).T # Lower left corner of image
    c2 = np.array([[-7,-43,-2],[25,-43,-2]]).T # Upper right corner of image
