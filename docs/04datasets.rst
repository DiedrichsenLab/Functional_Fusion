...
|    **Description**: A large battery of tasks that cover a wide range of cognitive domains, including perception, action, and memory. Includes xxhrs task data from 2 different tasks sets, collected over 4 days of scanning. Resting state data for xx subjects is also available (20min).
|    **Reference**: 
|    **No of subjects**: 24
|    **DOI**: 
|    **Download**: 
