...
if __name__ == "__main__":
    ...
    test_extract('WMFS','ses-s1','fs32k','CondHalf')
    test_extract('WMFS','ses-s2','fs32k','CondHalf')
    test_extract('WMFS','ses-s1','fs32k','CondRun')
    test_extract('WMFS','ses-s2','fs32k','CondRun')
    test_extract('WMFS','ses-s1','fs32k','CondAll')
    test_extract('WMFS','ses-s2','fs32k','CondAll')
    test_extract('WMFS','ses-s1','MNISymC3','CondHalf')
    test_extract('WMFS','ses-s2','MNISymC3','CondHalf')
    test_extract('WMFS','ses-s1','MNISymC3','CondRun')
    test_extract('WMFS','ses-s2','MNISymC3','CondRun')
    test_extract('WMFS','ses-s1','MNISymC3','CondAll')
    test_extract('WMFS','ses-s2','MNISymC3','CondAll')
