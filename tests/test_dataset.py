...
if __name__ == "__main__":
    ...
    test_extract('Nishimoto','ses-01','fs32k','CondHalf')
    test_extract('Nishimoto','ses-02','fs32k','CondHalf')
    test_extract('Nishimoto','ses-01','fs32k','CondRun')
    test_extract('Nishimoto','ses-02','fs32k','CondRun')
    test_extract('Nishimoto','ses-01','fs32k','CondAll')
    test_extract('Nishimoto','ses-02','fs32k','CondAll')
    test_extract('Nishimoto','ses-01','MNISymC3','CondHalf')
    test_extract('Nishimoto','ses-02','MNISymC3','CondHalf')
    test_extract('Nishimoto','ses-01','MNISymC3','CondRun')
    test_extract('Nishimoto','ses-02','MNISymC3','CondRun')
    test_extract('Nishimoto','ses-01','MNISymC3','CondAll')
    test_extract('Nishimoto','ses-02','MNISymC3','CondAll')
